_OKCP.changeUI = function(){
	...
	$('<a class="UI-change-button UI-change-button-okcp-img-grid UI-change-button-okcp-img-grid-width" href="javascript:void(0)">3 Wide</a>').prependTo('.monolith').hide().click(function(){
	...
	$('<a class="UI-change-button UI-change-button-okcp-img-grid UI-change-button-okcp-img-grid-toggle" href="javascript:void(0)">Pictures Mode</a>').prependTo('.monolith').click(function(){
	...
	function upgradeImageSizes() {
		$('#match_results .user_image img:not(.large-img)').each(function(){
			var newURL = _OKCP.getLargeThumbUrl(this.src);
			this.src = newURL;
